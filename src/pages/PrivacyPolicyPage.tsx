        ...
        <div className="bg-[#121218] p-6 sm:p-10 rounded-3xl border border-stone-800 shadow-xl space-y-6">
          <section className="space-y-3">
            ...
            <p className="text-stone-300">
              At <strong className="text-amber-300">Vishal Jogdeo Sangeet</strong> ("we", "our", or "us"), accessible via our official web portal, we respect your privacy and are committed to protecting personal information shared through event booking inquiries, newsletter subscriptions, or audio streaming services.
            </p>
          </section>
          ...
          <section className="space-y-3">
            ...
            <ul className="list-disc pl-5 space-y-2 text-stone-300">
              <li><strong className="text-amber-200">Contact Information:</strong> Name, phone number, email address, and event venue location provided voluntarily through the Event Booking Form or Contact Form.</li>
              <li><strong className="text-amber-200">Technical Data:</strong> Standard browser user-agent, device type, and anonymous aggregate page view metrics used to optimize streaming performance.</li>
              <li><strong className="text-amber-200">User Preferences:</strong> Audio volume settings, preferred lyrics font size, and selected devotional categories stored locally on your device.</li>
            </ul>
          </section>
          ...
          <section className="space-y-3">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-2">
              <div className="p-4 rounded-2xl bg-stone-900 border border-stone-800 space-y-1">
                ...
                <p className="text-xs text-stone-400">To coordinate performance logistics, venue requirements, and confirm booking inquiries.</p>
              </div>
              ...
              <div className="p-4 rounded-2xl bg-stone-900 border border-stone-800 space-y-1">
                ...
                <p className="text-xs text-stone-400">To send notifications about upcoming Abhanga Sandhya concerts and new song releases if requested.</p>
              </div>
            </div>
          </section>
          ...
          <section className="space-y-3">
            <h2 className="text-xl font-bold font-heading text-white">4. Third-Party Links & Media Services</h2>
            <p className="text-stone-300">
          ...
          <section className="space-y-3">
            <h2 className="text-xl font-bold font-heading text-white">5. Contact Our Management Team</h2>
            <p className="text-stone-300">
              If you have any questions or data requests regarding this Privacy Policy, please contact our official team at:
            </p>
            <div className="p-4 rounded-2xl bg-amber-950/40 border border-amber-500/30 text-xs text-amber-200 font-medium space-y-1">
              <p><strong className="text-amber-300">Vishal Jogdeo Official Management</strong></p>

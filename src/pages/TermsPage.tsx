      ...
      <div className="bg-[#FDFCFB] border-b border-stone-200/80 py-12">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-3">
          ...
          <h1 className="text-3xl sm:text-4xl font-extrabold font-heading text-stone-900">
            Terms & <span className="font-serif italic text-amber-900 font-normal">Conditions</span>
          </h1>
        ...
        <div className="bg-white p-6 sm:p-10 rounded-3xl border border-stone-200/80 shadow-sm space-y-6">
          <section className="space-y-3">
            ...
            <p className="text-stone-600">
              Welcome to the official website of <strong>Vishal Jogdeo Sangeet</strong>. By accessing this portal, reading devotional lyrics, streaming audio previews, or submitting concert booking requests, you agree to comply with and be bound by these Terms and Conditions.
            </p>
          </section>
          ...
          <section className="space-y-3">
            ...
            <ul className="list-disc pl-5 space-y-2 text-stone-600">
              <li><strong>Personal Use:</strong> Users are granted a limited license to stream audio and copy lyrics for personal, non-commercial devotional study.</li>
              <li><strong>Prohibited Actions:</strong> Commercial rebroadcast, unauthorized remixing, or re-selling of audio recordings without written authorization from Vishal Jogdeo Sangeet is strictly prohibited.</li>
            </ul>
          </section>
          ...
          <section className="space-y-3">
            <h2 className="text-xl font-bold font-heading text-stone-900">4. Disclaimer of Warranties</h2>
            <p className="text-stone-600">
          ...
          <section className="space-y-3">
            <h2 className="text-xl font-bold font-heading text-stone-900">5. Governance & Jurisdiction</h2>
            <p className="text-stone-600">

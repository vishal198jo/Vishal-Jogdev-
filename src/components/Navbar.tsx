  ...
  return (
    <header 
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
        isScrolled 
          ? 'bg-[#FDFCFB]/90 text-stone-900 backdrop-blur-md shadow-sm border-b border-stone-200/80 py-3.5' 
          : 'bg-[#FDFCFB]/80 text-stone-900 backdrop-blur-sm border-b border-stone-200/50 py-4'
      }`}
    >
